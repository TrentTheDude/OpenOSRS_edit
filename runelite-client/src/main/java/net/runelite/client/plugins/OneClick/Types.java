...
import net.runelite.client.plugins.OneClick.*;
import net.runelite.client.plugins.OneClick.Comparables.ClickCompare;
import net.runelite.client.plugins.OneClick.Comparables.misc.*;
import net.runelite.client.plugins.OneClick.Comparables.skilling.*;
